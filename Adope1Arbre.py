...
def page_Adopte():
    ...
    for select_taille in options_taille:
        if select_taille!="":
            df_arbre_select=df_arbre_select[df_arbre_select.loc[:,"classeTaille"]==select_taille]
    for select_rare in options_rare:
        if select_rare!="":
            df_arbre_select=df_arbre_select[df_arbre_select.loc[:,"rareOupas"]==select_rare]
